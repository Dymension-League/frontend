...
const SliderItem = props => (
    <div className="flat-title-page" style={{ backgroundImage: `url(${imgbg})` }}>
        <img className="bgr-gradient gradient1" src={shape1} alt="Dymension League" />
        <img className="bgr-gradient gradient2" src={shape2} alt="Dymension League" />
        <img className="bgr-gradient gradient3" src={shape3} alt="Dymension League" />
                            ...
                            <div className="wrap-heading flat-slider flex">
                                <div className="content">
                                    ...
                                    <div className="flat-bt-slider flex style2">
                                        <Link to="/mint-ships" className="sc-button header-slider style style-1 rocket fl-button pri-1"><span>Mint Your Ship</span></Link>
                                        <Link to="/create-team" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Create Team</span></Link>
                                    </div>
                                </div>
                                <div className="image">
                                    <img className="img-bg" src={props.item.imgbg} alt="Dymension League" />
                                    <img src={props.item.img} alt="Dymension League" />
                                </div>
                            </div>
                        </div>
                    </div>
